...
| D4 | Sala de espera y llamado (módulo `waiting_room`) | ◐ | Diseño en [`SALA-DE-ESPERA.md`](SALA-DE-ESPERA.md). Fase 1 hecha el 25-sep-2026: módulo apagado por defecto, `WaitingTicket`, número de sala al registrar llegadas y walk-ins, badges en recepción y diálogo con el número en grande. Pendientes: fase 2 (llamado con consultorio, `recall`, cierre, pestaña «Llamados», llamado desde el médico) y fase 3 (clave de dispositivo, feed público, pantalla `/sala`, sonido). |
